...
v4=0.9999999968880912*9+(0.6931471805*9);
v3=v4;
v2_arr[0]=v3;
//~~~Going into the loop~~~
C_i_S_i=logs[3];
for(int i_S_i=1;i_S_i<3;i_S_i++){
    ...
    v8=v9*(3-i_S_i);
    v7=v8*(i_S_i);
    v6=0.9999999968880912*((3-i_S_i)*(i_S_i))+0.9999999968880912*((3-i_S_i)*(3-i_S_i))+0.9999999968880912*((i_S_i)*(i_S_i))+v7+(0.6931471805*((i_S_i)*(i_S_i))+0.6931471805*((3-i_S_i)*(i_S_i))+0.6931471805*((3-i_S_i)*(3-i_S_i)));
    v2_arr[i_S_i]=C_i_S_i+v6+(sum(0.9999999968880912, 0.0)*((i_S_i)*(i_S_i))+sum(0.9999999968880912, 0.0)*((3-i_S_i)*(3-i_S_i)));
    C_i_S_i=(C_i_S_i-logs[i_S_i+1])+logs[(3)-i_S_i];
}
//~~~Boundary case where the prv is true for all individuals~~~
v15=0.9999999968880912*9+(0.6931471805*9);
v14=v15;
v2_arr[3]=v14;
v2=sum_arr(v2_arr, 3);
v1=v2;

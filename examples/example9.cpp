	...
	for(int i_Old_i=0;i_Old_i<=6;i_Old_i++){
		if(i_Old_i==0){
			...
			for(int i_Female_i=0;i_Female_i<=6;i_Female_i++){
				if(i_Female_i==0){
					v3_arr[i_Female_i]=60.2602416;
				}
				else if(i_Female_i!=6){
					v10=sum(0.0,1.20000301);
					v9=v10*(i_Female_i);
					v7=sum(0.0+(1.20000301*((i_Female_i)*(1))+0.69314718*((i_Female_i)*(1))),0.0+v9);
					v6=v7*(5);
					v3_arr[i_Female_i]=C_i_Female_i+(0.0*i_Female_i+0.0*(6-i_Female_i))+v6+(1.20000301*((6-i_Female_i)*(5))+0.69314718*((6-i_Female_i)*(5)));
				}
				else{
					v19=sum(0.0,1.20000301);
					v18=v19*(6);
					v16=sum(11.35890114,0.0+v18);
				...
				if(i_Female1_i==0){
					...
					if(6-i_Old_i==0){
						...
						for(int i_Female2_i=0;i_Female2_i<=6-i_Old_i;i_Female2_i++){
							if(i_Female2_i==0){
								v35_arr[i_Female2_i]=(1.20000301*((6-i_Old_i)*(5))+0.69314718*((6-i_Old_i)*(5))+3.4657359);
							}
							else if(i_Female2_i!=6-i_Old_i){
								v43=sum(0.0,1.20000301);
								v42=v43*(i_Female2_i);
								v40=sum(0.0+(1.20000301*((i_Female2_i)*(1))+0.69314718*((i_Female2_i)*(1))),0.0+v42);
								v39=v40*(5);
								v35_arr[i_Female2_i]=C_i_Female2_i+(0.0*i_Female2_i+0.0*(6-i_Old_i-i_Female2_i))+v39+(1.20000301*((6-i_Old_i-i_Female2_i)*(5))+0.69314718*((6-i_Old_i-i_Female2_i)*(5)));
							}
							else{
								v52=sum(0.0,1.20000301);
								v51=v52*(6-i_Old_i);
								v49=sum(0.0+(1.20000301*((6-i_Old_i)*(1))+0.69314718*((6-i_Old_i)*(1))),0.0+v51);
					...
					v26=v27+v35;
					v24_arr[i_Female1_i]=v26+(1.20000301*((i_Old_i)*(5)));
				}
				else if(i_Female1_i!=i_Old_i){
					if(6-i_Old_i==0){
						v62=sum(0.0,1.20000301);
						v61=v62*(i_Female1_i);
						v59=sum(0.0+(1.20000301*((i_Female1_i)*(1))+0.69314718*((i_Female1_i)*(1))),0.0+v61);
						v69=sum(0.0,1.2);
						v68=v69*(i_Female1_i);
						v74=sum(0.0,2.40000301);
						v73=v74*(i_Female1_i);
						v67=sum(0.0+v68+(1.20000301*((i_Female1_i)*(1))),0.0+v73);
						v79=sum(0.0,1.2);
						...
						for(int i_Female2_i=0;i_Female2_i<=6-i_Old_i;i_Female2_i++){
							if(i_Female2_i==0){
								v89=sum(0.0,1.20000301);
								v88=v89*(i_Female1_i);
								v86=sum(0.0+(1.20000301*((i_Female1_i)*(1))+0.69314718*((i_Female1_i)*(1))),0.0+v88);
								v96=sum(0.0,1.2);
								v95=v96*(i_Female1_i);
								v101=sum(0.0,2.40000301);
								v100=v101*(i_Female1_i);
								v94=sum(0.0+v95+(1.20000301*((i_Female1_i)*(1))),0.0+v100);
								v106=sum(0.0,1.2);
								...
								v84=v85*(5);
								v56_arr[i_Female2_i]=v84+(1.20000301*((6-i_Old_i)*(5))+0.69314718*((6-i_Old_i)*(5)));
							}
							else if(i_Female2_i!=6-i_Old_i){
								v116=sum(0.0,1.20000301);
								v115=v116*(i_Female1_i);
								v121=sum(0.0,1.20000301);
								v120=v121*(i_Female2_i);
								v114=v115+v120;
								v112=sum(0.0+(1.20000301*((i_Female1_i)*(1))+0.69314718*((i_Female1_i)*(1))+1.20000301*((i_Female2_i)*(1))+0.69314718*((i_Female2_i)*(1))),0.0+v114);
								v128=sum(0.0,1.2);
								v127=v128*(i_Female1_i);
								v134=sum(0.0,2.40000301);
								v133=v134*(i_Female1_i);
								v139=sum(0.0,1.20000301);
								v138=v139*(i_Female2_i);
								v132=v133+v138;
								v126=sum(0.0+v127+(1.20000301*((i_Female1_i)*(1))+1.20000301*((i_Female2_i)*(1))+0.69314718*((i_Female2_i)*(1))),0.0+v132);
								v144=sum(0.0,1.2);
								...
								v110=v111*(5);
								v56_arr[i_Female2_i]=C_i_Female2_i+(0.0*i_Female2_i+0.0*(6-i_Old_i-i_Female2_i))+v110+(1.20000301*((6-i_Old_i-i_Female2_i)*(5))+0.69314718*((6-i_Old_i-i_Female2_i)*(5)));
							}
							else{
								v155=sum(0.0,1.20000301);
								v154=v155*(6-i_Old_i);
								v160=sum(0.0,1.20000301);
								v159=v160*(i_Female1_i);
								v153=v154+v159;
								v151=sum(0.0+(1.20000301*((6-i_Old_i)*(1))+0.69314718*((6-i_Old_i)*(1))+1.20000301*((i_Female1_i)*(1))+0.69314718*((i_Female1_i)*(1))),0.0+v153);
								v167=sum(0.0,1.2);
								v166=v167*(i_Female1_i);
								v173=sum(0.0,1.20000301);
								v172=v173*(6-i_Old_i);
								v178=sum(0.0,2.40000301);
								v177=v178*(i_Female1_i);
								v171=v172+v177;
								v165=sum(0.0+v166+(1.20000301*((6-i_Old_i)*(1))+0.69314718*((6-i_Old_i)*(1))+1.20000301*((i_Female1_i)*(1))),0.0+v171);
								v183=sum(0.0,1.2);
					...
					v24_arr[i_Female1_i]=C_i_Female1_i+(0.0*i_Female1_i+0.0*(i_Old_i-i_Female1_i))+v56+(1.20000301*((i_Old_i-i_Female1_i)*(5)));
				}
				else{
					if(6-i_Old_i==0){
						v194=sum(0.0,1.20000301);
						v193=v194*(i_Old_i);
						v191=sum(0.0+(1.20000301*((i_Old_i)*(1))+0.69314718*((i_Old_i)*(1))),0.0+v193);
						v200=sum(0.0,1.2);
						v199=v200*(i_Old_i);
						v205=sum(0.0,2.40000301);
						v204=v205*(i_Old_i);
						v198=sum(0.0+v199+(1.20000301*((i_Old_i)*(1))),0.0+v204);
						...
						for(int i_Female2_i=0;i_Female2_i<=6-i_Old_i;i_Female2_i++){
							if(i_Female2_i==0){
								v215=sum(0.0,1.20000301);
								v214=v215*(i_Old_i);
								v212=sum(0.0+(1.20000301*((i_Old_i)*(1))+0.69314718*((i_Old_i)*(1))),0.0+v214);
								v221=sum(0.0,1.2);
								v220=v221*(i_Old_i);
								v226=sum(0.0,2.40000301);
								v225=v226*(i_Old_i);
								v219=sum(0.0+v220+(1.20000301*((i_Old_i)*(1))),0.0+v225);
								v211=sum(0.0+v212+(1.2*((i_Old_i)*(1))),0.0+v219);
								v210=v211*(5);
								v188_arr[i_Female2_i]=v210+(1.20000301*((6-i_Old_i)*(5))+0.69314718*((6-i_Old_i)*(5)));
							}
							else if(i_Female2_i!=6-i_Old_i){
								v236=sum(0.0,1.20000301);
								v235=v236*(i_Old_i);
								v241=sum(0.0,1.20000301);
								v240=v241*(i_Female2_i);
								v234=v235+v240;
								v232=sum(0.0+(1.20000301*((i_Old_i)*(1))+0.69314718*((i_Old_i)*(1))+1.20000301*((i_Female2_i)*(1))+0.69314718*((i_Female2_i)*(1))),0.0+v234);
								v247=sum(0.0,1.2);
								v246=v247*(i_Old_i);
								v253=sum(0.0,2.40000301);
								v252=v253*(i_Old_i);
								v258=sum(0.0,1.20000301);
								v257=v258*(i_Female2_i);
								v251=v252+v257;
								v245=sum(0.0+v246+(1.20000301*((i_Old_i)*(1))+1.20000301*((i_Female2_i)*(1))+0.69314718*((i_Female2_i)*(1))),0.0+v251);
								v231=sum(0.0+v232+(1.2*((i_Old_i)*(1))),0.0+v245);
								v230=v231*(5);
								v188_arr[i_Female2_i]=C_i_Female2_i+(0.0*i_Female2_i+0.0*(6-i_Old_i-i_Female2_i))+v230+(1.20000301*((6-i_Old_i-i_Female2_i)*(5))+0.69314718*((6-i_Old_i-i_Female2_i)*(5)));
							}
							else{
								v269=sum(0.0,1.20000301);
								v268=v269*(i_Old_i);
								v274=sum(0.0,1.20000301);
								v273=v274*(6-i_Old_i);
								v267=v268+v273;
								v265=sum(0.0+(1.20000301*((i_Old_i)*(1))+0.69314718*((i_Old_i)*(1))+1.20000301*((6-i_Old_i)*(1))+0.69314718*((6-i_Old_i)*(1))),0.0+v267);
								v280=sum(0.0,1.2);
								v279=v280*(i_Old_i);
								v286=sum(0.0,2.40000301);
								v285=v286*(i_Old_i);
								v291=sum(0.0,1.20000301);
								v290=v291*(6-i_Old_i);
								v284=v285+v290;
								v278=sum(0.0+v279+(1.20000301*((i_Old_i)*(1))+1.20000301*((6-i_Old_i)*(1))+0.69314718*((6-i_Old_i)*(1))),0.0+v284);
			...
			for(int i_Female_i=0;i_Female_i<=6;i_Female_i++){
				if(i_Female_i==0){
					...
					v304=v305*(5);
					v302_arr[i_Female_i]=v304+(36.000090300000004+3.4657359);
				}
				else if(i_Female_i!=6){
					v317=sum(0.0,1.20000301);
					v316=v317*(i_Female_i);
					v314=sum(0.0+(1.20000301*((i_Female_i)*(1))+0.69314718*((i_Female_i)*(1))),0.0+v316);
					v324=sum(0.0,1.2);
					v323=v324*(i_Female_i);
					v329=sum(0.0,2.40000301);
					v328=v329*(i_Female_i);
					v322=sum(0.0+v323+(1.20000301*((i_Female_i)*(1))),0.0+v328);
					v334=sum(0.0,1.2);
					v333=v334*(6-i_Female_i);
					v321=v322+v333;
					v313=sum(0.0+v314+(1.2*((i_Female_i)*(1))+1.2*((6-i_Female_i)*(1))+0.69314718*((6-i_Female_i)*(1))),0.0+v321);
					v312=v313*(5);
					v302_arr[i_Female_i]=C_i_Female_i+(0.0*i_Female_i+0.0*(6-i_Female_i))+v312+(1.20000301*((6-i_Female_i)*(5)));
				}
				else{
					v344=sum(0.0,1.20000301);
					v343=v344*(6);
					v341=sum(11.35890114,0.0+v343);
					v350=sum(0.0,1.2);
					v349=v350*(6);
					v355=sum(0.0,2.40000301);
					v354=v355*(6);
					v348=sum(0.0+v349+(7.2000180600000006),0.0+v354);
